...
class PaymentSignalRService {
  ...
  Stream<Map<String, dynamic>> get paymentStream => _controller.stream;
  ...
  Future<void> connect() async {
    ...
    final hubUrl = '${base.replaceAll(RegExp(r'/+$'), '')}/hubs/payment';
...
final paymentSignalRService = PaymentSignalRService();
